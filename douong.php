...
<section>
    <div class="list-menu">
        <div class="menu"><a href="lau.php">Lẩu</a></div>
        <div class="menu"><a href="monman.php">Món mặn</a></div>
        <div class="menu"><a href="monrau.php">Món rau</a></div>
        <div class="menu"><a href="monandacsac.php">Món ăn đặc sắc</a></div>
        <div class="do_uong"><a id='do_uong' href="douong.php">Đồ uống</a></div>
        <div class="menu"><a href="giavi.php">Gia vị</a></div>
    ...
    <div class="list-mon">
        ...
        $sql = "SELECT * FROM food_drink WHERE id_loai_food_drink = 4";
        $result = $conn->query($sql);
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<div class='test'>";
                echo "<img class='anh' src='ảnh/" . htmlspecialchars($row['image']) . "' style='width:100%;height:100%;'/>";
                ...
                echo "<span class='ten'>" . htmlspecialchars($row['ten_food_drink']) . "</span><br>";
                echo "<span class='gia'>" . htmlspecialchars($row['gia_food_drink']) . "</span><br>";
