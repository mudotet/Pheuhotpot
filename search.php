...
<body>
    <header>
        <nav>
            ...
            <div class="search_container">
                <form class="d-flex search-container" method="POST" action="">
                    <input class="form-control me-2" type="text" id="search" name="tim_food_drink" placeholder="Search...">
                    <button class="btn btn-outline-success" type="submit" name="search_food_drink">Search</button>
                                ...
                                if (isset($_SESSION['ten_khach_hang'])){
                                 ...
                                 elseif (isset($_SESSION['tai_khoan']) && $_SESSION['tai_khoan'] == 'admin@gmail.com') {
                                    echo "<li style='color:white'>Xin chào " . $_SESSION['tai_khoan'] . "</li>
                                          ...
                                          <li style='color:white'><a href='add_mon_an.html'>Chỉnh sửa món ăn</a></li>
                                          <li style='color:white'><a href='add_mon_an.html'>Xem các loại món ăn</a></li>
    ...
    <?php 
        ...
        if (isset($_POST['search_food_drink']) && isset($_POST['tim_food_drink'])) {
            require 'connect.php'; // Ensure this file contains the correct database connection
            mysqli_set_charset($conn,'UTF8');
            
            $tim_food_drink = $_POST['tim_food_drink'];
            $sql = "SELECT * FROM `food_drink` WHERE `ten_food_drink` LIKE ?";
            $stmt = $conn->prepare($sql);
            $searchTerm = "%" . $tim_food_drink . "%";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) { 
                    echo "<div class='test'>";
                    echo  "<img class='anh' src='ảnh/".$row['image']."' style='width:50%;height:100%;'/>";
    ...
    <div class="gio-hang">
        ...
        <form action="">
            ...
            <p>Tong tien:<span class="tong-tien">0</span></p>
            <button id="thanh-toan-btn" class="btn btn-success">Thanh toan</button>
            <div class="course_qr">
                <img class="course_qr_img" src=""/>
                <p>Noi dung chuyen khoan: <span class="paid_content">a</span></p>
                <p>So tien:<span class="paid">0</span></p>
            </div>
