...
<body>
    <header>
        <nav>
            ...
            <div class="nav">
                <div class="icon-user">
                    <li class="menu-li" style="list-style: none;"><a class="menu-a" href="#"><i class="fa-solid fa-bars"></i></a>
                        <ul class="menu-ul">
                            <?php 
                                if (isset($_SESSION['ten_khach_hang'])){
                                    echo "<li style='color:white'>Xin chào " . $_SESSION['ten_khach_hang'] . "</li>
                                          ...
                                          <li style='color:white'><a href='user_in4.php'>Thông tin</a></li>
                                          <li style='color:white'><a href='update_khach_hang.php'>Thay đổi mật khẩu</a></li>
    ...
    <section>
        <div class="list-menu">
            <div style= 'background-color: #f3ecdb;border-right:3px solid #3e503c ' class="menu" class="hot_pot" >
                <a style='color: #3e503c;' href="">Lẩu</a>
            </div>
                <?php
                    require 'connect.php';
                    mysqli_set_charset($conn,'UTF8');
                    $sql = "SELECT * FROM loai_food_drink";
                    $result = $conn->query($sql);
                    if($result->num_rows > 0){ 
                        ...
                        while($row = $result->fetch_assoc()){ 
                            echo "<div class='menu'>"?>
                            <a href="<?php
                            if($row["id_loai_food_drink"] == 1){
                                echo "monman.php
                                
                                ";
                            }
                            if($row["id_loai_food_drink"] == 2){
                                echo "monrau.php";
                            }
                            if($row["id_loai_food_drink"] == 3){
                                echo "monandacsac.php";
                            }
                            if($row["id_loai_food_drink"] == 4){
                                echo "douong.php";
                            }
                            if($row["id_loai_food_drink"] == 5){
                                echo "giavi.php";
                            }
                            ?>">
                            <?php echo $row['ten_loai_food_drink']?>
                            </a>
                            <?php echo "</div>";
                        }}
                ?>
        ...
        <div class="section-lau">
            <img src="https://thegioidogiadung.com.vn/3534-large_default/noi-lau-inox-elmich-el2870-26cm.jpg" width=600px>
        </div>
        <div class="list-lau">
            <?php
            require 'connect.php';
            ...
            if($result->num_rows > 0){ 
                ...
                while($row = $result->fetch_assoc()){ 
                    echo "<div class='lau'>";
                    echo  "<img class='anh' src='ảnh/".$row['image_lau']."' style='width:280px;height:180px;margin-top:10px'/>";
                    echo "<div class='text-lau'>";
                    echo "<span class='lau1'><input type='hidden' class='id_lau' value ='" .$row['id_lau']. "'></span><br>";
                    echo "<span class='ten'>".$row['ten_lau']."</span><br>";
                    echo "<span class='gia'>".$row['gia_lau']."</span><br>";
    ...
    <form action="mon-trong-hoa-don.php" method='get'>
        ...
        <p>Tổng tiền:<input type='text' class="tong-tien" name='total' value="0"></p>
