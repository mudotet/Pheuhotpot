...
<section>
    <div class="list-menu">
        ...
        <div class="menu">
            <a href="monandacsac.php">Món ăn đặc sắc</a>
        </div>
        <div class="menu">
            <a id="do_uong" href="douong.php">Đồ uống</a>
        </div>
        <div class="gia_vi">
            <a id="gia_vi" href="giavi.php">Gia vị</a>
        </div>
    ...
    <div class="list-mon">
        <?php
            ...
            $sql = "SELECT * FROM food_drink WHERE id_loai_food_drink = 5";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) { 
                while ($row = $result->fetch_assoc()) {
                    echo "<div class='test'>";
                    echo "<img class='anh' src='ảnh/" . htmlspecialchars($row['image']) . "' style='width:100%;height:100%;' alt='Image'/>";
