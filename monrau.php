...
<header>
    ...
    <div class="list-menu">
            ...
            <div class="mon_rau">
                <a id='mon_rau' href="monrau.php">Món rau</a>
            </div>
            <div class="menu">
        ...
        <div class="list-mon">
            ...
            $sql = "SELECT * FROM food_drink WHERE id_loai_food_drink = 2";
            $result = $conn->query($sql);
            if($result->num_rows > 0){ 
                ...
                while($row = $result->fetch_assoc()){
                    ...
                    echo  "<img class='anh' src='ảnh/".$row['image']."' style='width:100%;height:100%;'/>";
